...
$ignored_array = $ModerationManager->getIgnored($sort, $dir, $page);
$total_records = $ModerationManager->getIgnoredTotal();
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
	        <div class="jumbotron subhead">
				<h1>Ignored Videos</h1>
				<p class="lead">These videos have been ignored. If you change your mind and want to reject an ignored video, click the "reject" button.</p>
				<hr/>
			</div>				
		</div>
		<!-- /intro -->
		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<?if(!is_array($ignored_array)){?>
					There are no ignored videos to display.
				<?} else {?>
