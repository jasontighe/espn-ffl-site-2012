...
$queue_array = $ModerationManager->getUnmoderated($sort, $dir, $page);
$total_records = $ModerationManager->getUnmoderatedTotal();
...
<html lang="en">
  ...
  <body>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
	        <div class="jumbotron subhead">
				<h1>Queue</h1>
				<p class="lead">Please review all content, clicking "approve" to make a video public or "reject" to remove it entirely.</p>
				<hr/>
			</div>				
		</div>
		<!-- /intro -->
									...
									<div class="row-fluid">
										...
										<div class="span6" style="font-size:85% !important">
											<div style="margin-bottom:9px; line-height:11px">
												<b>Video Type:</b><br/>
												<?if($vid['video_type'] == "1"){?>Personalized<?}else{?>Pre-made<?}?>
											</div>
											<div style="margin-bottom:9px; line-height:11px">
												<b>League Name:</b><br/>
												<?=$vid['league_name']?>
											...
											<div style="margin-bottom:9px; line-height:11px">
												<span class="btn-group"><a class="btn btn-mini btn-success" rel="approve" data-vid="<?=$vid['league_id']?>"><b style="font-size:110%">APPROVE</b></a> <a class="btn btn-mini btn-success" rel="ignore" data-vid="<?=$vid['league_id']?>">IGNORE</a></span> <a class="btn btn-mini btn-danger" rel="reject" data-vid="<?=$vid['league_id']?>">REJECT</a>
											</div>
										</div>
									</div>
								</div>
	...
	<input type="hidden" id="approve_video_id" value="" />
	...
	<!-- modals -->
		...
		<!-- /reject -->
		<!-- approve -->
		<div class="modal hide" id="modal_approve">
  			<div class="modal-header"><button type="button" class="close" data-dismiss="modal">×</button><h3>Approve Video?</h3></div>
			<div class="modal-body"><p>Are you sure you wish to approve this video? Approved videos are made public.</p></div>
			<div class="modal-footer"><a href="#" class="btn" data-dismiss="modal">NO, cancel</a><a href="#" class="btn btn-success" rel="do_approve" data-dismiss="modal">YES, approve</a></div>
		</div>		
		<!-- /approve -->
		<!-- ignore -->
		<div class="modal hide" id="modal_ignore">
  			<div class="modal-header"><button type="button" class="close" data-dismiss="modal">×</button><h3>Ignore Video?</h3></div>
			<div class="modal-body"><p>Are you sure you wish to ignore this video? The video will remain unlisted on YouTube but will be removed from this queue.</p></div>
			<div class="modal-footer"><a href="#" class="btn" data-dismiss="modal">NO, cancel</a><a href="#" class="btn btn-success" rel="do_ignore" data-dismiss="modal">YES, ignore</a></div>
		</div>		
		<!-- /ignore -->
	<!-- /modals -->
	...
	<script language="javascript">
		$(document).ready(function(){
			$("a[rel^='prettyPhoto']").prettyPhoto({
				deeplinking: false,
				social_tools: '<div class="pp_social" id="pp_buttons"><span class="btn-group" style="float:left"><a class="btn btn-mini btn-success" rel="approve"><b style="font-size:110%">APPROVE</b></a><a class="btn btn-mini btn-success" rel="ignore">IGNORE</a></span>&nbsp;<a class="btn btn-mini btn-danger" rel="reject" >REJECT</a></div>'
			});
		});
	</script>
