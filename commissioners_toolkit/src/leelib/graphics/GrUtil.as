package leelib.graphics
{
	...
	public class GrUtil
	{
		...
		public static function makeCircle($radius:Number, $color:uint=0xff0000, $alpha:Number=1):Sprite
		{
			var s:Sprite = new Sprite();
			s.graphics.beginFill($color, $alpha);
		...
		public static function centerInParent($d:DisplayObject, $mathFloor:Boolean=false):void
		{
