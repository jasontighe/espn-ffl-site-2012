package leelib.ui
{
	...
	public class Component extends Sprite
	{
		...
		public static const EVENT_SHOWCOMPLETE:String = "Component.eventShowComplete";
		public static const EVENT_HIDECOMPLETE:String = "Component.eventHideComplete";
		...
		//
		public static function decompose($o:DisplayObjectContainer, $killBitmapDatas:Boolean=false):void
		{
			while ($o.numChildren > 0)
			{
				var o:DisplayObject = $o.getChildAt(0);
				if (o is DisplayObjectContainer)
				{
					decompose( DisplayObjectContainer(o) );
				}
				else
				{
					if (o is Bitmap && $killBitmapDatas) Bitmap(o).bitmapData = null;
				}
				
				if ($o is Component) Component($o).clearChildComponentArray();
				$o.removeChild(o);
			}
		}
	}
